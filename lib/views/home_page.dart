      ...
      body: ListView(
        children: [
          ...
          Row(
            children: [
              CachedNetworkImage(
                imageUrl: 'https://media.discordapp.net/attachments/1113021449591078946/1114096187147042826/Design_sans_titre.png',
                placeholder: (context, url) => CircularProgressIndicator(),
                width: screenWidth / 3,
              ),
              Image.network('https://media.discordapp.net/attachments/1113021449591078946/1114096187147042826/Design_sans_titre.png', width: screenWidth / 3),
              Image.network('https://media.discordapp.net/attachments/1113021449591078946/1114096187147042826/Design_sans_titre.png', width: screenWidth / 3)
            ]
          ),
          Counter(),
